program jeu_des_allumettes_IA_V1 (input, output);
...
procedure TourDeJeu (var Joueur1, Joueur2:CaracJoueur; Tour:integer;var Scoreboard:Scores);
        ...
        REPEAT
                ...
                IF (Tour MOD 2=0) THEN
                        begin
                        //IA
                        IF (Tas.NbTas=2) OR (Tas.NbTas=1) THEN //S'il reste 2 allumettes ou 1
                                begin
                                Joueur2.Choix:=1;//L IA enleve 1 allumette
                                end
                        ELSE
                                begin
                                IF (Tas.NbTas=3) THEN //Si il reste 3 allumettes
                                        begin
